export const TEAM_MEMBERS = {
  ...
  'gloomy302010@gmail.com': { name: 'Gloomy', roleKey: 'wiki_editor', roleLabel: 'WIKI Editor', icon: '📃' },
  ...
  'alieldaw6@gmail.com': { name: 'Kron3d', roleKey: 'wiki_editor', roleLabel: 'WIKI Editor', icon: '📃' },
